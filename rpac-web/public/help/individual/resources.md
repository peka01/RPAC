...
- Följa MSB:s beredskapstips
- Beräkna hur länge du klarar dig
- Dela överskott med ditt samhälle

**Tillgängliga funktioner:**
- MSB-rekommenderade resurskategorier
- Bulk-tillägg av resurser
- Hållbarhetspåminnelser
- Resursdelning med samhället
...
#### Sök efter resurs:
1. Använd sökfältet högst upp
2. Skriv namn på resurs (t.ex. "vatten")
3. Listan filtreras automatiskt

#### Filtrera efter kategori:
1. Klicka på kategori-flik (Mat, Vatten, Medicin, etc.)
2. Se endast resurser i den kategorin
3. Klicka "Alla" för att visa alla kategorier

#### Visa endast MSB-resurser:
- Använd filtret "Visa endast MSB-rekommenderade"
- Bra för att fokusera på grundläggande beredskap
...
### 8. Dela resurser med ditt samhälle
...
A: Poängen baseras på hur många av de 6 MSB-kategorierna du har fyllt i. Varje kategori med minst en resurs ger poäng. Full poäng = alla kategorier ifyllda.

**Q: Måste jag ange hållbarhet?**

A: Nej, hållbarhet är frivilligt. Men det hjälper dig att komma ihåg att rotera lager och byta ut saker i tid.

**Q: Vad händer om jag delar en resurs?**

A: När du delar en resurs syns den i ditt samhälles "Delade resurser"-flik. Andra medlemmar kan se den och kontakta dig för att låna/byta. Din egen kvantitet påverkas inte.

**Q: Kan andra se mina resurser?**

A: Nej! Dina resurser är privata. Endast du ser dem, såvida du inte aktivt väljer att dela en specifik resurs med ett samhälle.

**Q: Hur länge bör jag kunna klara mig?**

A: MSB rekommenderar minst 3-7 dagars förråd. Under kris kan det ta tid innan hjälp kommer eller butiker fylls på. Är du i gles-/landsbygd: sikta på 14 dagar.

## Relaterade sidor

- [Dashboard](/help/dashboard.md) - Se din beredskapspoäng
- [Individual - Cultivation](/help/individual/cultivation.md) - Odla egen mat för långsiktig självförsörjning
- [Local - Shared Resources](/help/local/resources-shared.md) - Se vad andra delar i ditt samhälle
- [Local - Help Requests](/help/local/resources-help.md) - Be om hjälp om du saknar något