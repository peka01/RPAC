...
import { AlertCircle, Users, MapPin, ChevronDown } from 'lucide-react';
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <div className="flex items-center gap-4 mb-6">
                <div className="bg-[#3D4A2B]/10 rounded-xl p-3">
                  <AlertCircle className="w-8 h-8 text-[#3D4A2B]" />
                </div>
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 mb-2">Hjälpförfrågningar</h1>
                  <p className="text-gray-600">Be om hjälp eller erbjud hjälp till andra medlemmar</p>
                </div>
              </div>
              ...
              <div className="bg-[#8B4513]/10 border border-[#8B4513]/20 rounded-lg p-6">
                ...
                <p className="text-gray-700 mb-4">
                  {userCommunities.length === 0 
                    ? 'Du är inte medlem i några lokala samhällen än. Gå med i ett samhälle för att se hjälpförfrågningar.'
                    : 'Du behöver vara medlem i ett lokalt samhälle för att se hjälpförfrågningar.'
                  }
                </p>
                <Link
                  href="/local/discover"
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="flex items-center gap-3 md:gap-4">
                <div className="bg-[#3D4A2B]/10 rounded-xl p-2 md:p-3">
                  <AlertCircle className="w-6 h-6 md:w-8 md:h-8 text-[#3D4A2B]" />
                </div>
                <div className="flex-1">
                  <h1 className="text-xl md:text-3xl font-bold text-gray-900 mb-1 md:mb-2">Hjälpförfrågningar</h1>
                  <p className="text-sm md:text-base text-gray-600">Be om hjälp eller erbjud hjälp till andra medlemmar</p>
                </div>
              </div>
