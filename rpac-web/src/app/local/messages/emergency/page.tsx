...
import { AlertTriangle, Users, MapPin, ChevronDown } from 'lucide-react';
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 mb-2">Nödsituationer</h1>
                  <p className="text-gray-600">Kritiska meddelanden och nödsituationer</p>
                </div>
              </div>
