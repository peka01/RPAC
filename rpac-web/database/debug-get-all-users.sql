-- =============================================
-- DEBUG get_all_users FUNCTION
-- =============================================
-- This creates a simple test function to debug the type mismatch
-- Created: 2025-01-27
...
BEGIN
  ...
  SELECT up.user_tier::TEXT INTO v_admin_tier
  ...
  SELECT
    ...
    COALESCE(up.user_tier, '')::TEXT as user_tier,
    COALESCE(up.license_type, '')::TEXT as license_type,
...
DO $$
BEGIN
  RAISE NOTICE '✅ Debug get_all_users function created!';
  RAISE NOTICE '✅ All return types are now TEXT to avoid type mismatches';
END $$;
