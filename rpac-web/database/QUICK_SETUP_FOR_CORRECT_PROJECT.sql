-- =============================================
-- QUICK SETUP FOR CORRECT SUPABASE PROJECT
-- =============================================
-- Run this in the project with URL: dsoujjudzrrtkkqwhpge.supabase.co
...
-- 5. Make user 34645cf8 super admin
DO $$
BEGIN
  ...
  ELSE
    INSERT INTO user_profiles (
      ...
      '34645cf8-7ee5-4a3c-ab06-d1ac8f2ab721', 'super_admin', 'free', true,
      'svealand', 1, NOW(), NOW()
    );
