-- Fix cultivation_reminders table structure
-- This migration drops and recreates the table with the correct columns
-- WARNING: This will delete any existing data in cultivation_reminders

-- Drop old table if it exists
DROP TABLE IF EXISTS cultivation_reminders CASCADE;

-- Create the correct cultivation_reminders table
